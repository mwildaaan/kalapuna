...
Future<void> main(List<String> args) async {
  ...
  String libPathFolder = "$appRootFolder/lib";
  ...
  String modulesPathFolder = "$libPathFolder/modules";
  if (!Directory(modulesPathFolder).existsSync()) {
    print("CREATE PATH modules => $modulesPathFolder");
    Directory(modulesPathFolder).createSync(recursive: true);
  }
